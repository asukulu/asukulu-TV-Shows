...
import com.example.tvshow.adapter.EpisodesAdapter;
import com.example.tvshow.adapter.ImageSliderAdapter;
...
import com.example.tvshow.viewmodels.TVShowInfo_V_Model;
...
public class TVShowDetailsActivity extends AppCompatActivity {
    ...
    private TVShowInfo_V_Model tvShowDetailsViewModel;
    ...
    private void doInitializalition() {
        tvShowDetailsViewModel = new ViewModelProvider(this).get(TVShowInfo_V_Model.class);
    ...
    private void checkTVShowInWatchlist() {
        ...
        compositeDisposable.add(tvShowDetailsViewModel.getTVSHowFromWatchist(String.valueOf(tvShow.getId()))
    ...
    private void getTVShowDetails() {
        ...
        tvShowDetailsViewModel.getTVShowInfo(tvShowId).observe(this, tvShowDetailsResponse -> {
                    activityTvshowDetailsBinding.setIsLoading(false);
                    //Toast.makeText(getApplicationContext(), tvShowDetailsResponse.getTvShowDetails().getUrl(), Toast.LENGTH_SHORT).show();
                    if (tvShowDetailsResponse.getTvShowInfo() != null) {
                        if (tvShowDetailsResponse.getTvShowInfo().getPictures() != null) {
                            loadImageSlider(tvShowDetailsResponse.getTvShowInfo().getPictures());


                        }

                        activityTvshowDetailsBinding.setTvShowImageURL(tvShowDetailsResponse.getTvShowInfo().getImagePath());
                        activityTvshowDetailsBinding.imageTVShow.setVisibility(View.VISIBLE);
                        activityTvshowDetailsBinding.setDescription(
                                String.valueOf(
                                        HtmlCompat.fromHtml(
                                                tvShowDetailsResponse.getTvShowInfo().getDescription(),
                        ...
                        activityTvshowDetailsBinding.setRating(
                                String.format(
                                        Locale.getDefault(),
                                        "%.2f",
                                        Double.parseDouble(tvShowDetailsResponse.getTvShowInfo().getRating())
                                )
                        );
                        if (tvShowDetailsResponse.getTvShowInfo().getGenres() != null) {
                            activityTvshowDetailsBinding.setGenre(tvShowDetailsResponse.getTvShowInfo().getGenres()[0]);
                        } else {
                            activityTvshowDetailsBinding.setGenre("N/A");
                        }
                        activityTvshowDetailsBinding.setRuntime(tvShowDetailsResponse.getTvShowInfo().getRuntime() + " Min");
                        ...
                        activityTvshowDetailsBinding.buttonWebsite.setOnClickListener(v -> {
                            ...
                            intent.setData(Uri.parse(tvShowDetailsResponse.getTvShowInfo().getUrl()));
                        ...
                        activityTvshowDetailsBinding.buttonEpisodes.setOnClickListener(v -> {
                            if (episodesBottomSheetDialog == null) {
                                ...
                                layoutEpisodesBottomSheetBinding.episodesRecyclerView.setAdapter(
                                        new EpisodesAdapter(tvShowDetailsResponse.getTvShowInfo().getEpisodes())
                                );
